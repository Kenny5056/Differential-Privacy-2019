function [data] = PQDeepLearningTrainCreation(train,epsilon)
data = zeros(60000,27,27);
% noisytrainX = zeros(60000,729);
W = wavsize(3);

for i = 1:60000
kk = reshape(train(i,:), 28, 28)';
J = kk(1:27,1:27);
